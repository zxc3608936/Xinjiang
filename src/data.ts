    ...
    events: [
      {
        ...
        category: 'transport',
        title: '啟程前往賽里木湖與薰衣草田',
        desc: '因獨庫公路管制，今日行程改為反穿路線，首先前往賽里木湖。',
      },
      {
        id: 'e7-2',
        time: '11:00',
      ...
      },
      {
        ...
        category: 'attraction',
        title: '伊犁薰衣草田 (季節限定)',
        desc: '東方普羅旺斯，漫步於迷人的紫色花海。',
        detailedDesc: '伊犁河谷與法國普羅旺斯地處同一緯度帶，氣候和土壤條件相似，是中國最大的薰衣草種植基地，也被譽為「中國薰衣草之鄉」。每年6月中下旬至7月上旬是薰衣草盛開的最佳季節，大片紫色的花海在微風中搖曳，散發出醉人的香氣，景色夢幻浪漫。',
        query: '伊犁薰衣草',
      },
      {
        id: 'e7-4',
    ...
    events: [
      {
        ...
        image: '/Nalati.jpg',
        detailedDesc: '那拉提草原地處天山腹地，被譽為「空中草原」，是世界上著名的四大河谷草原之一。這裡不僅有起伏的翠綠草甸、茂盛的原始森林，還有戴雪的山峰交相輝映，景色立體而豐富。除了絕美的自然風光，那拉提也是哈薩克族人口聚居最集中的地區之一，在此可以深入體驗騎馬、射箭、品嚐奶茶等濃郁的民族風情。',
        query: '那拉提草原',
      },
      {
        id: 'e8-2',
        ...
        category: 'hotel',
        title: '入住那拉提鎮飯店',
        desc: '由於行程異動，今晚改為入住那拉提鎮上酒店，體驗當地小鎮風情及品嘗美食。',
        query: '那拉提镇'
      }
    ]
  },
    ...
    events: [
      {
        ...
        category: 'attraction',
        title: '二進那拉提 / 獨庫公路中段',
        desc: '早晨可再次領略那拉提晨曦，隨後途經獨庫公路中段前往巴音布魯克。',
        detailedDesc: '今天將再次經過那拉提草原的部分區域，隨後沿著獨庫公路中段行駛，穿越群山，前往巴音布魯克。這段路程能夠欣賞到壯麗的峽谷及高山草甸景觀。',
      },
      {
        id: 'e9-2',
        time: '14:30',
        ...
        detailedDesc: '巴音布魯克草原位於天山山脈中段的高山盆地，是中國第二大草原，也是中國最大的高山草原。這裡有著名的「天鵝湖」，能見到大天鵝、小天鵝及疣鼻天鵝等。而「九曲十八彎」的開都河流經平坦的草原，在夕陽西下時，河面上會同時倒映出多個太陽的奇景，壯美無比，令人歎為觀止。',
        query: '巴音布鲁克草原',
      },
      {
        id: 'e9-3',
    ...
    events: [
      {
        ...
        time: '08:30',
        category: 'transport',
        title: '啟程返回烏魯木齊 (繞行218國道)',
        desc: '因獨庫公路管制，本日將繞行218國道，經天山勝利隧道返回烏魯木齊，原獨山子大峽谷景點取消。',
        detailedDesc: '這是一段漫長的車程，將帶您從高山草原回到城市，途中可欣賞不同海拔與地形的壯闊風貌。',
      },
      {
        id: 'e10-2',
        time: '19:00',
